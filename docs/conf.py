...
project = 'nmraspecds'
copyright = '2022-24, Mirjam Schröder'
...
latex_documents = [
    (master_doc, 'nmraspecds.tex', 'nmraspecds Documentation',
     'Mirjam Schröder', 'manual'),
]
...
man_pages = [
    (master_doc, 'nmraspecds', 'nmraspecds Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nmraspecds', 'nmraspecds Documentation',
     author, 'nmraspecds', 'ASpecD derived Package for recipe driven data analysis of NMR spectra',
     'Miscellaneous'),
]
